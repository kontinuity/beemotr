...
/**
 * OTR policies are used to define per-correspondent behaviors for each contact
 * Alice wishes to communicate with. The policies are any combination of the
...
public class Policy {
  ...
  public static final byte ALWAYS = ALLOW_V1 | ALLOW_V2 | REQUIRE_ENCRYPTION | WHITESPACE_START_AKE
      | ERROR_START_AKE;
