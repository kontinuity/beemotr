...
/**
 * <p>
 * The interface that allows 2 parties to generate a shared secret by exchanging
 * their public keys with each other.
 * </p>
 * <ol>
 ...
 * <li>The result of generateSecret() is the shared secret that both parties
 * know.</li>
 * </ol>
 * 
...
public interface KeyAgreement {
  ...
  /**
   * Returns the shared secret computed using the last public key used by
   * generateSecret(). The result is returned in MPI form. If generateSecret()
   * has not been called before invoking this method, null is returned.
   * 
   * @return the shared secret. Returns null if a shared secret has not been
   *         computed.
   */
