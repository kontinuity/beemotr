...
public class JCASHA256 extends ca.uwaterloo.crysp.otr.crypt.SHA256 {
  ...
  /*
   * public static void main(String args[]) throws OTRCryptException{ SHA256 d =
   * new SHA256(); byte[] message = "Hello ".getBytes(); byte[] message2 =
   * "world".getBytes(); d.update(message); d.update(message2); byte[] s =
   * d.hash(); d.hash("Hello world".getBytes()); boolean r = d.verify(s,
   * "Hello world".getBytes()); System.out.println(r); }
   */
