...
public class JCASHA1 extends ca.uwaterloo.crysp.otr.crypt.SHA1 {
  ...
  /*
   * public static void main(String args[]) throws Exception{ SHA1 sha = new
   * SHA1(); byte[] msg1 = "Test message 1".getBytes(); byte[] digest1; try {
   * digest1 = sha.hash(msg1); byte[] msg2 = "Another test message".getBytes();
   * AuthInfo.checkBytes("msg1", digest1);
   * System.out.println(sha.verify(digest1, msg1));
   * System.out.println(sha.verify(digest1, msg2)); } catch (OTRCryptException
   * e) { e.printStackTrace(); } byte[] msg3
   * ="c7d54f4c520b7adfe3a85b3f2b7d66cf20afc9b54bcc934c395057de18148947"
   * .getBytes(); msg3 = fromHex(msg3); sha = new SHA1(); digest1 =
   * sha.hash(msg3); AuthInfo.checkBytes("digest", digest1); }
   */
