 ...
 */
public class JCADSAPublicKey extends JCADSAKey implements ca.uwaterloo.crysp.otr.crypt.DSAPublicKey {
  ...
  public JCADSAPublicKey(BigInteger p, BigInteger q, BigInteger g, BigInteger y) throws Exception {
    DSAPublicKeySpec pubspec = new DSAPublicKeySpec(y, p, q, g);
    java.security.KeyFactory kfac = java.security.KeyFactory.getInstance("DSA");
    this.pk = (java.security.interfaces.DSAPublicKey)kfac.generatePublic(pubspec);
  ...
  public JCADSAPublicKey(MPI p, MPI q, MPI g, MPI y) throws Exception {
    DSAPublicKeySpec pubspec = new DSAPublicKeySpec(JCAMPI.fromTrimmedBytes(y.getValue()),
        JCAMPI.fromTrimmedBytes(p.getValue()), JCAMPI.fromTrimmedBytes(q.getValue()),
