...
public abstract class Provider {
   ...
   * 
   * @return an integer greater than 0, if ours is greater than theirs; an
   *         integer less than 0, if ours is less than theirs; 0, if the two are
   *         equal
   */
   ...
   */
  public abstract DSAPublicKey getDSAPublicKey(MPI p, MPI q, MPI g, MPI y) throws Exception;
