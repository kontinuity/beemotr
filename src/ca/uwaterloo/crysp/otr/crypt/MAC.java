 ...
 * must first be specified using setKey(). Following this, the tag() and
 * verify() methods can then be used to tag/verify data.
 * 
...
public interface MAC {
  ...
  public boolean verify(byte[] tag, byte[] data) throws OTRCryptException;

  /**
   * Verifies the tag for the data provided, starting at the provided offset.
   * 
   * @param tag the tag bytes to be verified.
   * @param data the data to be verified against.
