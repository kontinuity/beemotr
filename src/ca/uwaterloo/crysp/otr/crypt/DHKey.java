...
/**
 * Abstract class for a Diffie-Hellman Key. Each key stores its value as well as
 * the Diffie Hellman parameters: p and g.
 * 
...
public abstract class DHKey implements Key {
  ...
  /**
   * Returns the generator of the multiplicative group modulo p. The result is
   * in MPI format.
   * 
