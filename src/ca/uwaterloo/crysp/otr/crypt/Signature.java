...
/**
 * Interface for signing and verifying data. To use this class, a key pair must
 * first be specified using setKeyPair(). Following this, the sign() and
 * verify() methods can then be used to sign/verify data.
 * 
...
public interface Signature {
   ...
   * @throws OTRCryptException
   */
  public boolean verify(PublicKey pub, byte[] signature, byte[] data) throws OTRCryptException;
}
