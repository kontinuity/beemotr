...
/**
 * Abstract class for AES in counter mode. This is a symmetric algorithm with
 ...
 * <ol>
 * <li>CTRBLK is made up of 8 high bytes (specified by constructor), and 8 lower
 * bytes (the counter)</li>
 ...
 * <li>CTRBLK's counter is incremented by 1 for each successive block of
 * plaintext.</li>
 * </ol>
 * Decryption behaves in the same manner as encryption. The RFC can be located
 * at: <a
 * href="http://www.rfc-editor.org/rfc/rfc3686.txt">http://www.rfc-editor.
 * org/rfc/rfc3686.txt</a>
 * 
...
public abstract class AESCTR extends AbstractCipher {
  ...
  /**
   * Sets the high bits used in the control block. Only the first 8 bytes are
   * copied.
   * 
