...
public class OutBuf {
  ...
  public int writeBytes(byte[] data, int offset, int length) throws OTRException {
    if (len < length)
      throw new OTRException();
  ...
  /**
   * Return the contents of the buffer in Base64 format. Puts "?OTR:" at the
   * front of the buffer, and '.' at the end.
   * 
