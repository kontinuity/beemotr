...
public abstract class OTRMessage {
  ...
  public static final String MSG_TAG_BASE = " \t  \t\t\t\t \t \t \t  "; // Identifies
                                                                        // tagged
                                                                        // plaintext
                                                                        // messages
  public static final String MSG_TAG_V2 = "  \t\t  \t ";
  public static final String MSG_ENCODED_PREFIX = "?OTR:"; // Prefix of all
                                                           // encoded OTR
                                                           // messages
  ...
  public static final byte MSG_TAGGED_WHITESPACE = (byte)0x01; // Tagged
                                                               // whitespace
                                                               // message
  ...
  public static final byte MSG_REVEAL_SIGNATURE = (byte)0x11; // Reveal
                                                              // signature
                                                              // message
  ...
  /**
   * Factory method: parses bytes from input stream and returns an appropriate
   * OTRMessage subclass
   * 
  ...
  public String toString() {
    return this.getClass().getName() + " [messageType=" + messageType + "]";
  }
}
