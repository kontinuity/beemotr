...
public class RevealSignatureMessage extends OTREncodedMessage {
   ...
   */
  public RevealSignatureMessage(short protocolVersion, Data revealedKey, Data encryptedSignature,
      Data sigmac) {
   ...
   * @throws OTRException
   */
  public static RevealSignatureMessage readRevealSignatureMessage(InBuf stream,
      short protocolVersion) throws OTRException {
