...
public class DataMessage extends OTREncodedMessage {
   ...
   * @throws OTRException
   */
  public static DataMessage readDataMessage(InBuf stream, short protocolVersion)
      throws OTRException {
    ...
    return new DataMessage(protocolVersion, flags, senderKeyId, recipientKeyId, DHy, ctrInit,
        encryptedMessage, macAuthenticator, oldMacKeys);
  }
  ...
  public int getSize() {
    ...
    return (1 + 2 + 1 + 4 + 4 + DHy.getLength() + 1 + encryptedMessage.getLength()
        + macAuthenticator.length + maclen);
  }
