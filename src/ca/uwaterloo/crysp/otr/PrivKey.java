...
public class PrivKey {
  ...
  /*
   * public void dump() { for (int i = 0; i < pubkey_data.length; ++i) {
   * System.out.print(" " + pubkey_data[i]); } System.out.println(""); }
   */
  ...
  public static byte[] fingerprintRaw(UserState us, String accountname, String protocol,
      Provider prov) throws OTRException {
