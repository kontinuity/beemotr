...
public class ResendSubscription extends AlertDialog.Builder {
   ...
   */
  public ResendSubscription(final Context context, final IXmppFacade xmppFacade,
    ...
    public void onClick(final DialogInterface dialog, final int which) {
      if (which == DialogInterface.BUTTON_POSITIVE) {
        ...
        try {
          ...
          Toast
              .makeText(mContext, mContext.getString(R.string.userinfo_resend), Toast.LENGTH_SHORT)
              .show();
