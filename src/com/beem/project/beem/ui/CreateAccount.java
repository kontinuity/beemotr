...
public class CreateAccount extends Activity {
  ...
  private boolean createAccount(String username, String password) {
    ...
    try {
      ...
      Toast toast = Toast.makeText(getApplicationContext(),
          String.format(getString(R.string.create_account_successfull_after), username),
  ...
  private void createErrorDialog(String errMsg) {
    ...
    builder.setTitle(R.string.create_account_err_dialog_title).setMessage(errMsg)
  ...
  private int getRegisteredProxyPort() {
    return Integer.parseInt(mSettings.getString(BeemApplication.PROXY_PORT_KEY,
  ...
  /**
   * Initialize the "Create this account" button which allows the user to create
   * an account.
   */
