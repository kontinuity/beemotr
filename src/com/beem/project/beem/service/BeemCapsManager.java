...
/**
 * An implementation of CapsManager which keeps DiscoverInfo on the Cache
 * directory of the android application.
 */
public class BeemCapsManager extends CapsManager {
   ...
   */
  public BeemCapsManager(final ServiceDiscoveryManager sdm, final Connection conn,
   ...
   * @throws XmlPullParserException if an error occurs while creating the
   *           parser.
   */
